 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var R = decodeURI("%73cript"),
        ...
        U = function() {
            var a = A.nonce;
            if (void 0 !== a)
                return a && a === String(a) && a.match(S)
                    ? a
                    : (A.nonce = null);
            var b = u(A, "us", []);
            if (!b || !b.length) return (A.nonce = null);
            for (
                var c = h.getElementsByTagName(R), d = 0, e = c.length;
                d < e;
                ++d
            ) {
                var f = c[d];
                if (
                    f.src &&
                    (a =
                        String(f.nonce || f.getAttribute("nonce") || "") ||
                        null)
                ) {
...
gapi.load("", {
    ...
    _c: {
        jsl: {
            ci: {
                ...
                iframes: {
                    ...
                    udc_webconsentflow: {
                        params: { url: "" },
                        url:
                            "https://myaccount.google.com/webconsent?usegapi\u003d1"
                    },
                    savetoandroidpay: {
            ...
            h:
                "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.jW2btP9ChQU.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCM0q-XhO2z_rhJmMCxwCih0ECmNuA",
            u: "https://apis.google.com/js/api.js",
            hee: true,
            fp: "7d1fefd72bb34a6b638b2f3d784fe6b787b377e3",
            dpo: false
        },
        fp: "7d1fefd72bb34a6b638b2f3d784fe6b787b377e3",
        annotation: [
