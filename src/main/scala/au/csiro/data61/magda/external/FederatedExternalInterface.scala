...
//class FederatedExternalInterface(val interfaces: Seq[ExternalInterface], implicit val ec: ExecutionContext) extends ExternalInterface {
//  override def search(query: String): Future[Either[String, SearchResult]] = {
//    interfaces.head.search(query)
