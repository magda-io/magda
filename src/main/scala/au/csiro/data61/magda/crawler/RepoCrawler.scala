...
//
//class RepoCrawler(supervisor: ActorRef, interfaceDef: InterfaceConfig) extends Actor with ActorLogging {
...
//          supervisor ! Index(interfaceDef.name, dataSetsWithCatalog)
