...
//
//class Indexer(supervisor: ActorRef) extends Actor with ActorLogging with Stash {
...
//      }
//
//      filteredDataSets match {
//        case Nil => supervisor ! IndexFinished(filteredDataSets, source)
//        case _ => searchProvider.index(source, filteredDataSets) onComplete {
