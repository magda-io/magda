...
import {
  fetchFeaturedPublishersFromRegistry
} from "./actions/featuredPublishersActions";
...
function loadDefaultData(store) {
  store.dispatch(
    fetchFeaturedPublishersFromRegistry(config.featuredPublishers)
  );
