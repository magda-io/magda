...
CREATE TABLE "public"."operations" (
    "id" int4 NOT NULL DEFAULT nextval('operations_id_seq'::regclass),
...
ALTER TABLE "public"."user_roles" ADD FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "public"."user_roles" ADD FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- Add default roles
INSERT INTO "public"."roles" ("id", "name", "description", "create_by", "create_time", "edit_by", "edit_time") VALUES ('00000000-0000-0001-0000-000000000000', 'Anonymous Users', 'Default role for unauthenticated users', NULL, '2019-04-04 04:18:41.21616+00', NULL, '2019-04-04 04:18:41.21616+00'),
...
INSERT INTO "public"."user_roles" ("id", "user_id", "role_id") VALUES ('5d73c6e5-bdc9-4cb3-9f06-fada3ae7648e', '00000000-0000-4000-8000-000000000000', '00000000-0000-0002-0000-000000000000'),
('7b9a62e2-6f23-4cc2-93ff-a2bc31e476b0', '00000000-0000-4000-8000-000000000000', '00000000-0000-0003-0000-000000000000');
