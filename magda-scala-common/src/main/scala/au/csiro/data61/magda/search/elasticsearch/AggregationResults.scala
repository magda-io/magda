package au.csiro.data61.magda.search.elasticsearch.AggregationResults
...
case class TermBucket(key: String, override val docCount: Long,  val data: Map[String, Any])
...
case class HistogramBucket(key: Double, override val docCount: Long,  val data: Map[String, Any])
  extends AggBucket
...
object KeyedDateRangeAggResult {
  // type clash with `buckets` on apply method
   def fromData(name: String, data: Map[String, Any]): KeyedDateRangeAggResult =
...
object DateRangeBucket {
   def apply(map: Map[String, Any]): DateRangeBucket = DateRangeBucket(
...
case class RangeAggResult(name: String, buckets: Seq[RangeBucket],  val data: Map[String, Any])
  extends BucketAggregation
...
object RangeBucket {
   def apply(data: Map[String, Any]): RangeBucket = RangeBucket(
...
case class GeoHashGridBucket(key: String, override val docCount: Long,  val data: Map[String, Any])
  extends AggBucket
...
case class ChildrenAggResult(name: String, docCount: Long,  val data: Map[String, Any])
...
case class NestedAggResult(name: String,  val data: Map[String, Any]) extends HasAggregations
...
trait HasAggregations extends Transformable {
  ...
  override  def data: Map[String, Any]
...
case class GlobalAggregationResult(name: String, docCount: Int,  val data: Map[String, Any])
  extends BucketAggregation
    with HasAggregations

case class FilterAggregationResult(name: String, docCount: Int,  val data: Map[String, Any])
  extends BucketAggregation
    with HasAggregations

case class UnnamedFilterAggregationResult(docCount: Long,  val data: Map[String, Any])
  extends HasAggregations
