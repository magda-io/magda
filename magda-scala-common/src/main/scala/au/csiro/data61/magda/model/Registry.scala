...
object RegistryModel {
  ...
  object RegistryEvent extends DefaultJsonProtocol {
...
trait RegistryProtocols
  ...
  implicit object A extends RootJsonFormat[ApiModelProperty] {
    def write(e: ApiModelProperty) = JsString(e.toString)
...
object RegistryConverters extends RegistryProtocols {
