...
export class AspectDefinitionsApi {
     ...
     */
    public create (aspect: string) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: AspectDefinition;  }>((resolve, reject) => {
     ...
     * 
     */
    public getAll () : Promise<{ response: http.ClientResponse; body: Array<AspectDefinition>;  }> {
        const localVarPath = this.basePath + '/aspects';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: Array<AspectDefinition>;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getById (id: string) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
     ...
     */
    public patchById (id: string, aspectPatch: any) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/aspects/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     */
    public putById (id: string, aspect: string) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/aspects/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
...
export class RecordAspectsApi {
     ...
     */
    public deleteById (recordId: string, aspectId: string) : Promise<{ response: http.ClientResponse; body: DeleteResult;  }> {
        ...
        return new Promise<{ response: http.ClientResponse; body: DeleteResult;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getAll (recordId: string) : Promise<{ response: http.ClientResponse; body: { [key: string]: any; };  }> {
     ...
     */
    public getById (recordId: string, aspectId: string) : Promise<{ response: http.ClientResponse; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
     ...
     * @param aspectPatch The RFC 6902 patch to apply to the aspect.
     */
    public patchById (recordId: string, aspectId: string, aspectPatch: any) : Promise<{ response: http.ClientResponse; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
     ...
     */
    public putById (recordId: string, aspectId: string, aspect: string) : Promise<{ response: http.ClientResponse; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
...
export class RecordsApi {
     ...
     */
    public create (record: string) : Promise<{ response: http.ClientResponse; body: Record;  }> {
     ...
     */
    public getAll (aspect?: Array<string>, optionalAspect?: Array<string>, pageToken?: string, start?: number, limit?: number, dereference?: boolean) : Promise<{ response: http.ClientResponse; body: Array<RecordSummary>;  }> {
        const localVarPath = this.basePath + '/records';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
        ...
        return new Promise<{ response: http.ClientResponse; body: Array<RecordSummary>;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param dereference true to automatically dereference links to other records; false to leave them as links.  Dereferencing a link means including the record itself where the link would be.  Dereferencing only happens one level deep, regardless of the value of this parameter.
     */
    public getById (id: string, aspect?: Array<string>, optionalAspect?: Array<string>, dereference?: boolean) : Promise<{ response: http.ClientResponse; body: Record;  }> {
     ...
     */
    public patchById (id: string, recordPatch: any) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/records/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     */
    public putById (id: string, record: string) : Promise<{ response: http.ClientResponse; body: Record;  }> {
        const localVarPath = this.basePath + '/records/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
...
export class WebHooksApi {
     ...
     */
    public create (hook: WebHook) : Promise<{ response: http.ClientResponse; body: WebHook;  }> {
     ...
     * 
     */
    public getAll () : Promise<{ response: http.ClientResponse; body: Array<WebHook>;  }> {
        const localVarPath = this.basePath + '/hooks';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public getById (id: string) : Promise<{ response: http.ClientResponse; body: WebHook;  }> {
