declare module "jsverify" {
  ...
  function forall<A, B, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    prop: (t: A, u: B) => Property<T>
  ): Property<T>;
  function forall<A, B, C, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    prop: (t: A, u: B, v: C) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    prop: (t: A, u: B, v: C, w: D) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    arb5: Arbitrary<E>,
    prop: (t: A, u: B, v: C, w: D, e: E) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, F, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    arb5: Arbitrary<E>,
    arb6: Arbitrary<F>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, F, G, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    ...
    arb6: Arbitrary<F>,
    arb7: Arbitrary<G>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F, b: G) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, F, G, H, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    ...
    arb7: Arbitrary<G>,
    arb8: Arbitrary<H>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F, b: G, c: H) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, F, G, H, I, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    ...
    arb8: Arbitrary<H>,
    arb9: Arbitrary<I>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F, b: G, c: H, d: I) => Property<T>
  ): Property<T>;
  function forall<A, B, C, D, E, F, G, H, I, J, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  /* tslint:disable:max-line-length */
  function assertForall<A, T>(
    arb1: Arbitrary<A>,
    prop: (t: A) => Property<T>
  ): T;
  function assertForall<A, B, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    prop: (t: A, u: B) => Property<T>
  ): T;
  function assertForall<A, B, C, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    prop: (t: A, u: B, v: C) => Property<T>
  ): T;
  function assertForall<A, B, C, D, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, F, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, F, G, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, F, G, H, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, F, G, H, I, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function assertForall<A, B, C, D, E, F, G, H, I, J, T>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function checkForall<A, B>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    prop: (t: A, u: B) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    prop: (t: A, u: B, v: C) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    prop: (t: A, u: B, v: C, w: D) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D, E>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    arb5: Arbitrary<E>,
    prop: (t: A, u: B, v: C, w: D, e: E) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D, E, F>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    arb5: Arbitrary<E>,
    arb6: Arbitrary<F>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D, E, F, G>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    ...
    arb6: Arbitrary<F>,
    arb7: Arbitrary<G>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F, b: G) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D, E, F, G, H>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
    ...
    arb7: Arbitrary<G>,
    arb8: Arbitrary<H>,
    prop: (t: A, u: B, v: C, w: D, e: E, a: F, b: G, c: H) => Property<any>
  ): Result<any>;
  function checkForall<A, B, C, D, E, F, G, H, I>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function checkForall<A, B, C, D, E, F, G, H, I, J>(
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
    arb4: Arbitrary<D>,
  ...
  function property<A, B, C, D, E, F, G, H, I>(
    description: String,
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
  ...
  function property<A, B, C, D, E, F, G, H, I, J>(
    description: String,
    arb1: Arbitrary<A>,
    arb2: Arbitrary<B>,
    arb3: Arbitrary<C>,
