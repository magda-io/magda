...
export class AspectDefinitionsApi {
     ...
     */
    public create (xMagdaTenantId: number, aspect: AspectDefinition, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: AspectDefinition;  }> {
     ...
     * @param xMagdaTenantId 0
     */
    public getAll (xMagdaTenantId: number) : Promise<{ response: http.IncomingMessage; body: Array<AspectDefinition>;  }> {
        const localVarPath = this.basePath + '/aspects';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public getById (xMagdaTenantId: number, id: string) : Promise<{ response: http.IncomingMessage; body: AspectDefinition;  }> {
     ...
     * @param xMagdaSession Magda internal session id
     */
    public patchById (xMagdaTenantId: number, id: string, aspectPatch: Array<Operation>, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/aspects/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param xMagdaSession Magda internal session id
     */
    public putById (xMagdaTenantId: number, id: string, aspect: AspectDefinition, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/aspects/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
...
export class RecordAspectsApi {
     ...
     * @param xMagdaSession Magda internal session id
     */
    public deleteById (xMagdaTenantId: number, recordId: string, aspectId: string, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: DeleteResult;  }> {
     ...
     */
    public getById (xMagdaTenantId: number, recordId: string, aspectId: string) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
     ...
     * @param xMagdaSession Magda internal session id
     */
    public patchById (xMagdaTenantId: number, recordId: string, aspectId: string, aspectPatch: Array<Operation>, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
     ...
     * @param xMagdaSession Magda internal session id
     */
    public putById (xMagdaTenantId: number, recordId: string, aspectId: string, aspect: any, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
...
export class RecordHistoryApi {
     ...
     */
    public history (xMagdaTenantId: number, recordId: string) : Promise<{ response: http.IncomingMessage; body: EventsPage;  }> {
     ...
     */
    public version (xMagdaTenantId: number, recordId: string, eventId: string) : Promise<{ response: http.IncomingMessage; body: Record;  }> {
...
export class RecordsApi {
     ...
     * @param xMagdaSession Magda internal session id
     */
    public create (xMagdaTenantId: number, record: Record, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: Record;  }> {
     ...
     * @param xMagdaSession Magda internal session id
     */
    public deleteById (xMagdaTenantId: number, recordId: string, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: DeleteResult;  }> {
     ...
     */
    public getAll (xMagdaTenantId: number, aspect?: Array<string>, optionalAspect?: Array<string>, pageToken?: string, start?: number, limit?: number, dereference?: boolean, aspectQuery?: Array<string>) : Promise<{ response: http.IncomingMessage; body: Array<Record>;  }> {
        const localVarPath = this.basePath + '/records';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     * @param limit The maximum number of records to receive.  The response will include a token that can be passed as the pageToken parameter to a future request to continue receiving results where this query leaves off.
     */
    public getAllSummary (xMagdaTenantId: number, pageToken?: string, start?: number, limit?: number) : Promise<{ response: http.IncomingMessage; body: Array<RecordSummary>;  }> {
     ...
     * @param dereference true to automatically dereference links to other records; false to leave them as links.  Dereferencing a link means including the record itself where the link would be.  Dereferencing only happens one level deep, regardless of the value of this parameter.
     */
    public getById (xMagdaTenantId: number, id: string, aspect?: Array<string>, optionalAspect?: Array<string>, dereference?: boolean) : Promise<{ response: http.IncomingMessage; body: Record;  }> {
     ...
     * @param id ID of the record to be fetched.
     */
    public getByIdSummary (xMagdaTenantId: number, id: string) : Promise<{ response: http.IncomingMessage; body: RecordSummary;  }> {
     ...
     * @param aspectQuery Filter the records returned by a value within the aspect JSON. Expressed as &#39;aspectId.path.to.field:value&#39;, url encoded. NOTE: This is an early stage API and may change greatly in the future
     */
    public getCount (xMagdaTenantId: number, aspect?: Array<string>, aspectQuery?: Array<string>) : Promise<{ response: http.IncomingMessage; body: CountResponse;  }> {
     ...
     */
    public getPageTokens (xMagdaTenantId: number, aspect?: Array<string>, limit?: number) : Promise<{ response: http.IncomingMessage; body: Array<string>;  }> {
     ...
     * @param xMagdaSession Magda internal session id
     */
    public patchById (xMagdaTenantId: number, id: string, recordPatch: Array<Operation>, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/records/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param xMagdaSession Magda internal session id
     */
    public putById (xMagdaTenantId: number, id: string, record: Record, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: Record;  }> {
        const localVarPath = this.basePath + '/records/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param xMagdaSession Magda internal session id
     */
    public trimBySourceTag (xMagdaTenantId: number, sourceTagToPreserve: string, sourceId: string, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: MultipleDeleteResult;  }> {
        const localVarPath = this.basePath + '/records';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
...
export class TenantsApi {
     ...
     * @param xMagdaTenantId 0
     */
    public getAll (xMagdaTenantId: number) : Promise<{ response: http.IncomingMessage; body: Array<Tenant>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<Tenant>;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public getByDomainName (xMagdaTenantId: number, domainName: string) : Promise<{ response: http.IncomingMessage; body: Tenant;  }> {
        const localVarPath = this.basePath + '/tenants/{domainName}'
            .replace('{' + 'domainName' + '}', String(domainName));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
        ...
        // verify required parameter 'xMagdaTenantId' is not null or undefined
        if (xMagdaTenantId === null || xMagdaTenantId === undefined) {
            throw new Error('Required parameter xMagdaTenantId was null or undefined when calling getByDomainName.');
        }

        // verify required parameter 'domainName' is not null or undefined
        if (domainName === null || domainName === undefined) {
            throw new Error('Required parameter domainName was null or undefined when calling getByDomainName.');
        }
...
export class WebHooksApi {
    ...
    public ack (id: string, acknowledgement: WebHookAcknowledgement, xMagdaSession: string) : Promise<{ response: http.IncomingMessage; body: WebHookAcknowledgementResponse;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: WebHookAcknowledgementResponse;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
