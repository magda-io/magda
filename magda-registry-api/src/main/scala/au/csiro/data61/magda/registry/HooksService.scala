...
class HooksService(config: Config, webHookActor: ActorRef, authClient: AuthApiClient, system: ActorSystem, materializer: Materializer) extends Protocols with SprayJsonSupport {
   ...
   * @api {get} http://registry-api/v0/registry/hooks Get a list of all web hooks
   *
  ...
  /**
   * @apiGroup Registry Webhooks
   * @api {post} http://registry-api/v0/registry/hooks Create a new web hook
   *
  ...
  /**
   * @apiGroup Registry Webhooks
   * @api {get} http://registry-api/v0/registry/hooks/{id} Get a web hook by ID
   *
  ...
  /**
   * @apiGroup Registry Webhooks
   * @api {put} http://registry-api/v0/registry/hooks/{id} Modify a web hook by ID
   *
  ...
  /**
   * @apiGroup Registry Webhooks
   * @api {delete} http://registry-api/v0/registry/hooks/{id} Delete a web hook
   *
  ...
  /**
   * @apiGroup Registry Webhooks
   * @api {post} http://registry-api/v0/registry/hooks/{id}/ack Acknowledge a previously-deferred web hook
   *
