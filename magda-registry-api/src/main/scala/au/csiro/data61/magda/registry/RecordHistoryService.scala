...
/**
  ...
  * @api {get} /v0/registry-ro/records/{recordId}/history/{eventId} Get the version of a record that existed after a given event was applied
  *
...
class RecordHistoryService(system: ActorSystem, materializer: Materializer) extends Protocols with SprayJsonSupport {
  ...
  /**
    * @apiGroup Registry Record History
    * @api {get} /v0/registry-ro/records/{recordId}/history Get a list of all events affecting this record
    *
