...
object AspectValidator {
    ...
    def validate(aspectId:String, aspectData: JsObject, tenantId: TenantId)(implicit session: DBSession, config: Config) {
    ...
    def validateAspects(aspects: Map[String, JsObject], tenantId: TenantId)(implicit session: DBSession, config: Config): Unit = {
    ...
    def validateWithAspectPatch(aspectPatch: JsonPatch, recordId: String, aspectId: String, tenantId: TenantId)(implicit session: DBSession, config: Config): Unit = {
    ...
    def validateWithRecordPatch(recordPatch: JsonPatch, recordId: String, tenantId: TenantId)(implicit session: DBSession, config: Config): Unit = {
