...
export class AspectDefinitionsApi {
     ...
     */
    public create (aspect: AspectDefinition) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
     ...
     */
    public putById (id: string, aspect: AspectDefinition) : Promise<{ response: http.ClientResponse; body: AspectDefinition;  }> {
        const localVarPath = this.basePath + '/aspects/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
...
export class RecordAspectsApi {
     ...
     */
    public putById (recordId: string, aspectId: string, aspect: any) : Promise<{ response: http.ClientResponse; body: any;  }> {
        const localVarPath = this.basePath + '/records/{recordId}/aspects/{aspectId}'
            .replace('{' + 'recordId' + '}', String(recordId))
            .replace('{' + 'aspectId' + '}', String(aspectId));
        let queryParameters: any = {};
...
export class RecordsApi {
     ...
     */
    public create (record: Record) : Promise<{ response: http.ClientResponse; body: Record;  }> {
     ...
     */
    public getAll (aspect?: Array<string>, aspects?: string) : Promise<{ response: http.ClientResponse; body: Array<RecordSummary>;  }> {
        const localVarPath = this.basePath + '/records';
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public getById (id: string) : Promise<{ response: http.ClientResponse; body: Record;  }> {
     ...
     */
    public putById (id: string, record: Record) : Promise<{ response: http.ClientResponse; body: Record;  }> {
        const localVarPath = this.basePath + '/records/{id}'
            .replace('{' + 'id' + '}', String(id));
        let queryParameters: any = {};
        let headerParams: any = (<any>Object).assign({}, this.defaultHeaders);
