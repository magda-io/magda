...
trait SearchQueryer {
  ...
  def searchRegions(query: Option[String], regionType: Option[String], steId: Option[String], sa4Id: Option[String], sa3Id: Option[String], sa2Id: Option[String], start: Long, limit: Int, tenantId: BigInt): Future[RegionSearchResult]
