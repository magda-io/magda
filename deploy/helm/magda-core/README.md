...
|------------|------|---------|
| file://../internal-charts/admin-api | admin-api | 6.0.0-alpha.2 |
| file://../internal-charts/apidocs-server | apidocs-server | 6.0.0-alpha.2 |
| file://../internal-charts/authorization-api | authorization-api | 6.0.0-alpha.2 |
| file://../internal-charts/authorization-db | authorization-db | 6.0.0-alpha.2 |
| file://../internal-charts/cloud-sql-proxy | cloud-sql-proxy | 6.0.0-alpha.2 |
| file://../internal-charts/combined-db | combined-db | 6.0.0-alpha.2 |
| file://../internal-charts/content-api | content-api | 6.0.0-alpha.2 |
| file://../internal-charts/content-db | content-db | 6.0.0-alpha.2 |
| file://../internal-charts/correspondence-api | correspondence-api | 6.0.0-alpha.2 |
| file://../internal-charts/elasticsearch | elasticsearch | 6.0.0-alpha.2 |
| file://../internal-charts/gateway | gateway | 6.0.0-alpha.2 |
| file://../internal-charts/indexer | indexer | 6.0.0-alpha.2 |
| file://../internal-charts/ingress | ingress | 6.0.0-alpha.2 |
| file://../internal-charts/opensearch-dashboards | opensearch-dashboards | 6.0.0-alpha.2 |
| file://../internal-charts/opensearch | opensearch | 6.0.0-alpha.2 |
| file://../internal-charts/priorities | priorities | 6.0.0-alpha.2 |
| file://../internal-charts/rds-dev-proxy | rds-dev-proxy | 6.0.0-alpha.2 |
| file://../internal-charts/registry-api | registry-api | 6.0.0-alpha.2 |
| file://../internal-charts/registry-db | registry-db | 6.0.0-alpha.2 |
| file://../internal-charts/search-api-node | search-api-node | 6.0.0-alpha.2 |
| file://../internal-charts/search-api | search-api | 6.0.0-alpha.2 |
| file://../internal-charts/session-db | session-db | 6.0.0-alpha.2 |
| file://../internal-charts/storage-api | storage-api | 6.0.0-alpha.2 |
| file://../internal-charts/tenant-api | tenant-api | 6.0.0-alpha.2 |
| file://../internal-charts/tenant-db | tenant-db | 6.0.0-alpha.2 |
| file://../internal-charts/web-server | web-server | 6.0.0-alpha.2 |
| file://../magda-common | magda-common | 6.0.0-alpha.2 |
...
| global.searchEngine.semanticIndexer.elasticSearch | object | `{"indices":{"semanticIndex":{"indexName":"semantic-index","knnVectorFieldConfig":{"compressionLevel":null,"dimension":768,"efConstruction":100,"efSearch":100,"encoder":{"clip":false,"name":"sq","type":"fp16"},"m":16,"mode":"in_memory","spaceType":"l2"},"settings":{"number_of_replicas":0,"number_of_shards":1}}},"serverUrl":"http://opensearch:9200"}` | Elasticsearch configuration. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.compressionLevel | string | `nil` | The compression_level mapping parameter selects a quantization encoder that reduces vector memory consumption by the given factor. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.dimension | int | `768` | Dimension of the embedding vectors. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.efConstruction | int | `100` | Similar to efSearch but used during index construction. Higher values improve search quality but increase index build time. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.efSearch | int | `100` | The size of the candidate queue during search. Larger values may improve search quality but increase search latency. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.encoder | object | `{"clip":false,"name":"sq","type":"fp16"}` | FAISS Encoder configuration (If compressionLevel is set, encoder will be ignored). |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.m | int | `16` | The maximum number of graph edges per vector. Higher values increase memory usage but may improve search quality. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.knnVectorFieldConfig.mode | string | `"in_memory"` | Vector workload mode: `on_disk` or `in_memory`. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.settings.number_of_replicas | int | `0` | The number of replica shards in the index. |
| global.searchEngine.semanticIndexer.elasticSearch.indices.semanticIndex.settings.number_of_shards | int | `1` | The number of primary shards in the index. |
| global.searchEngine.semanticIndexer.embeddingApi.baseUrl | string | `"http://magda-embedding-api"` |  |
