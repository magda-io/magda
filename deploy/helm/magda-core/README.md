...
![Version: 6.0.0-pr.3646.2](https://img.shields.io/badge/Version-6.0.0--pr.3646.2-informational?style=flat-square)
...
|------------|------|---------|
| file://../internal-charts/admin-api | admin-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/apidocs-server | apidocs-server | 6.0.0-pr.3646.2 |
| file://../internal-charts/authorization-api | authorization-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/authorization-db | authorization-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/cloud-sql-proxy | cloud-sql-proxy | 6.0.0-pr.3646.2 |
| file://../internal-charts/combined-db | combined-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/content-api | content-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/content-db | content-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/correspondence-api | correspondence-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/elasticsearch | elasticsearch | 6.0.0-pr.3646.2 |
| file://../internal-charts/gateway | gateway | 6.0.0-pr.3646.2 |
| file://../internal-charts/indexer | indexer | 6.0.0-pr.3646.2 |
| file://../internal-charts/ingress | ingress | 6.0.0-pr.3646.2 |
| file://../internal-charts/magda-redis | magda-redis | 6.0.0-pr.3646.2 |
| file://../internal-charts/opensearch-dashboards | opensearch-dashboards | 6.0.0-pr.3646.2 |
| file://../internal-charts/opensearch | opensearch | 6.0.0-pr.3646.2 |
| file://../internal-charts/priorities | priorities | 6.0.0-pr.3646.2 |
| file://../internal-charts/rds-dev-proxy | rds-dev-proxy | 6.0.0-pr.3646.2 |
| file://../internal-charts/registry-api | registry-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/registry-db | registry-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/search-api-node | search-api-node | 6.0.0-pr.3646.2 |
| file://../internal-charts/search-api | search-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/semantic-search-api | semantic-search-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/session-db | session-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/storage-api | storage-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/tenant-api | tenant-api | 6.0.0-pr.3646.2 |
| file://../internal-charts/tenant-db | tenant-db | 6.0.0-pr.3646.2 |
| file://../internal-charts/web-server | web-server | 6.0.0-pr.3646.2 |
| file://../magda-common | magda-common | 6.0.0-pr.3646.2 |
...
| global.redis | object | `{"enabled":true,"host":"","passwordSecret":"","port":6379}` | Redis configuration for accessing shared Redis cache used by registry-api and semantic-search-api. When `enabled` is true, an in-cluster Redis instance will be deployed. When `enabled` is false, services will connect to an external Redis via the provided `host`. |
| global.redis.enabled | bool | `true` | Whether to deploy an internal Redis instance. Set to `false` to use an external Redis and specify the `host` and `port`. |
| global.redis.host | string | `""` | Redis host address. When `enabled` is true, this can be left empty (defaults to service name `magda-redis`). When `enabled` is false, this must be set to the external Redis address. |
| global.redis.passwordSecret | string | `""` | Name of the Kubernetes Secret containing Redis password. The password will be loaded from the key `redis-password`. Leave empty if Redis requires no authentication. |
| global.redis.port | int | `6379` | Redis port number |
