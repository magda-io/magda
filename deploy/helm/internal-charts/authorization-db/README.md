...
| magda-postgresql.postgresql.fullnameOverride | string | `"authorization-db-postgresql"` |  |
| magda-postgresql.postgresql.nameOverride | string | `"authorization-db-postgresql"` |  |
