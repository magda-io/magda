...
| postgresql-wrapper.postgresql.fullnameOverride | string | `"content-db-postgresql"` |  |
| postgresql-wrapper.postgresql.nameOverride | string | `"content-db-postgresql"` |  |
| postgresql-wrapper.postgresql.persistence.size | string | `"50Gi"` |  |
