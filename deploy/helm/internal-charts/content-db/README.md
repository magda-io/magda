...
| magda-postgresql.postgresql.fullnameOverride | string | `"content-db-postgresql"` |  |
| magda-postgresql.postgresql.nameOverride | string | `"content-db-postgresql"` |  |
| magda-postgresql.postgresql.persistence.size | string | `"50Gi"` |  |
