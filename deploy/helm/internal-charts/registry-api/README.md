...
| appConfig.redis.db | int | `0` | Redis database number |
| appConfig.redis.host | string | `"magda-redis-master"` | Redis connection host |
| appConfig.redis.port | int | `6379` | Redis connection port |
| appConfig.redis.timeout | string | `"1h"` | Redis connection timeout |
