...
|------------|------|---------|
| file://../magda-core | magda-core | 7.0.0-pr.3792.0 |
| oci://ghcr.io/magda-io/charts | ckan-connector-functions(magda-ckan-connector) | 2.0.0 |
| oci://ghcr.io/magda-io/charts | magda-csv-semantic-indexer | 1.0.0-alpha.2 |
...
| oci://ghcr.io/magda-io/charts | minion-format(magda-minion-format) | 2.0.2 |
...
| oci://ghcr.io/magda-io/charts | magda-pdf-semantic-indexer | 1.0.1 |
...
| global.searchEngine | object | `{"defaultDatasetBucket":"magda-datasets","semanticIndexer":{"indexName":"semantic-index","indexVersion":1,"knnVectorFieldConfig":{"compressionLevel":"32x","dimension":768,"efConstruction":100,"efSearch":100,"encoder":null,"m":16,"mode":"on_disk","spaceType":"l2"},"numberOfReplicas":0,"numberOfShards":1}}` | Search engine configuration, only used for semantic indexer. |
...
| tags.csv-semantic-indexer | bool | `true` |  |
| tags.magda-csv-semantic-indexer | bool | `true` |  |
| tags.magda-pdf-semantic-indexer | bool | `true` |  |
...
| tags.pdf-semantic-indexer | bool | `true` |  |
