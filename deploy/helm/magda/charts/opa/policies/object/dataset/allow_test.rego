        ...
        "object": {
            "dataset": {
                "accessControl": {
                    ...
                    "preAuthoisedPermissionIds": ["xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx"]
                },
...
test_allow_pre_authoised_constraint_permission_user_permission_is_not_pre_authorised {
    not allow with input as {
        "operationUri": "object/dataset/draft/read",
        "object": {
            "dataset": {
...
test_allow_pre_authoised_constraint_permission_user_permission_is_pre_authorised {
    allow with input as {
        "operationUri": "object/dataset/draft/read",
        "object": {
            "dataset": {
                "accessControl": {
                    "ownerId": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx",
                    "orgUnitOwnerId": "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx",
                    "preAuthoisedPermissionIds": ["72d52505-cf96-47b2-9b74-d0fdc1f5aee7"]
                },
                "publishingState": "draft"
            }
        },
...
test_allow_pre_authoised_constraint_permission_user_permission_is_pre_authorised_for_incorrect_publishing_state {
    not allow with input as {
        "operationUri": "object/dataset/draft/read",
        "object": {
            "dataset": {
