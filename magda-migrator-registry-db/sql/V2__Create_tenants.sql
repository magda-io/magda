...
INSERT INTO Tenants(domainName, id, description, lastUpdate) VALUES('default', 0, 'Initial entry used for migrating database from single tenant to multi-tenants.', 1);
...
ALTER TABLE recordaspects ADD CONSTRAINT recordaspects_recordid_fkey FOREIGN KEY (recordId)
    REFERENCES records(recordId) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
