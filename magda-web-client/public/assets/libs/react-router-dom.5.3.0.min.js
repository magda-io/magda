!(function (t, e) {
            ...
            function t() {
                ...
                return (
                    ((t =
                        ...
                        var p = P(a, 0, r.length - 1),
                            h = r.map(function (t) {
                                return L(
                                    t,
                                    void 0,
                                    "string" == typeof t ? l() : t.key || l()
                                );
                            }),
                            d = _;
                        function v(t) {
                            var e = P(y.index + t, 0, y.entries.length - 1),
                                n = y.entries[e];
                        ...
                        var y = {
                            ...
                            push: function (t, e) {
                                ...
                                s.confirmTransitionTo(r, "PUSH", o, function (
                                    t
                                ) {
                                    if (t) {
                                        var e = y.index + 1,
    ...
    var _t = (function (t) {
        ...
        return (
            ...
            (e.prototype.render = function () {
                var c = this;
                return C.createElement(xt.Consumer, null, function (t) {
                    t || k(!1);
    ...
    var Nt = (function (o) {
        ...
        Ht = (function (t) {
            ...
            return (
                ...
                (e.prototype.render = function () {
                    var t = this;
                    return C.createElement(xt.Consumer, null, function (n) {
                        n || k(!1);
                        var r,
                            o,
    ...
    var zt = (function (o) {
            function t() {
                ...
                return (
                    ((t =
                        o.call.apply(o, [this].concat(n)) || this).history = b(
                        t.props
                    )),
                    t
                );
        ...
        qt = (function (o) {
            function t() {
                ...
                return (
                    ((t =
                        o.call.apply(o, [this].concat(n)) || this).history = x(
                        t.props
                    )),
                    t
                );
    ...
    var Gt = Kt(function (t, e) {
            ...
            return (c.ref = (Vt !== Kt && e) || n), C.createElement("a", c);
        }),
        Yt = Kt(function (t, i) {
            var e = t.component,
                a = void 0 === e ? Gt : e,
            ...
            return C.createElement(xt.Consumer, null, function (n) {
                n || k(!1);
                var r = n.history,
                    t = Wt(Dt(u, n.location), n.location),
                    e = t ? r.createHref(t) : "",
                    o = T({}, f, {
                        href: e,
                        navigate: function () {
                            var t = Dt(u, n.location),
                                e = _(n.location) === _(Wt(t));
                            (c || e ? r.replace : r.push)(t);
                        }
                    });
                return (
                    Vt !== Kt ? (o.ref = i || s) : (o.innerRef = s),
                    C.createElement(a, o)
                );
            });
        }),
    ...
    var Xt = Qt(function (t, f) {
        ...
        return C.createElement(xt.Consumer, null, function (t) {
            ...
            return (
                Jt !== Qt ? (s.ref = f || P) : (s.innerRef = P),
                C.createElement(Yt, s)
            );
        });
    });
    (t.BrowserRouter = zt),
        ...
        (t.withRouter = function (r) {
            function t(t) {
                ...
                return C.createElement(xt.Consumer, null, function (t) {
                    return (
                        t || k(!1), C.createElement(r, T({}, n, t, { ref: e }))
                    );
                });
            }
...
//# sourceMappingURL=react-router-dom.5.3.0.min.js.map
