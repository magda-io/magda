    ...
    var j =
        ...
        k = (function (o) {
            function t() {
                ...
                return (
                    ((t =
                        o.call.apply(o, [this].concat(n)) || this).history = S(
                        t.props
                    )),
                    t
                );
    ...
    function z(p) {
        ...
        return function (t, e) {
            for (
                var n = "",
                    r = t || {},
                    o = (e || {}).pretty ? W : encodeURIComponent,
                    i = 0;
                i < p.length;
                i++
            ) {
    ...
    (t.MemoryRouter = k),
        ...
        (t.withRouter = function (r) {
            function t(t) {
                ...
                return s.createElement(A.Consumer, null, function (t) {
                    return (
                        t || P(!1), s.createElement(r, v({}, n, t, { ref: e }))
                    );
                });
            }
...
//# sourceMappingURL=react-router.5.2.1.min.js.map
