                        ...
                        <div className="row">
                            <div className="col-sm-4 text-block-container">
                                <div className="text-block text-block-1">
                                    You can easily{" "}
                                    <strong>
                                        add a new record of a dataset to your
                                        internal catalogue
                                    </strong>{" "}
                            ...
                            <div className="col-sm-4 text-block-container">
                                <div className="text-block text-block-2">
                                    ...
                                    to ensure every dataset has a complete and
                                    high quality metadata record, without the
                                    need for arduous data entry.
                                </div>
                            </div>
                            <div className="col-sm-4 text-block-container">
                                <div className="text-block text-block-3">
                                    You can{" "}
                                    <strong>
                                        save your metadata records as a draft
                                    </strong>{" "}
