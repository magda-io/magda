...
storiesOf("API viewer", module)
    ...
    .add("dataset detail viewer", () => (
        <ApiViewer
            url="http://search.data.gov.au/api/v0/registry-rorecords/19432f89-dc3a-4ef3-b943-5326ef1dbecc?aspect=dcat-dataset-strings&optionalAspect=dcat-distribution-strings&optionalAspect=dataset-distributions&optionalAspect=temporal-coverage&dereference=true&optionalAspect=dataset-publisher&optionalAspect=source&optionalAspect=source-link-status"
            type="json"
        />
    ));
