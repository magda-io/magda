...
const argv = yargs
    ...
    .option('jwtSecret', {
        describe: 'The secret to use to sign JSON Web Token (JKT) for authenticated requests.  This can also be specified with the JWT_SECRET environment variable.',
        type: 'string',
        default: process.env.JWT_SECRET || process.env.npm_package_config_JWT_SECRET,
        demand: true
    })
    .option('sessionSecret', {
        ...
        type: 'string',
        default: process.env.SESSION_SECRET || process.env.npm_package_config_SESSION_SECRET,
        demand: true
    })
