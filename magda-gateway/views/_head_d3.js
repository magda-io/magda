...
(function (global, factory) {
            ...
            if (
                meridian
                    ? polar
                        ? (phi0 + phi1 > 0) ^
                          (q[1] <
                              (abs(q[0] - lambda0) < epsilon$2 ? phi0 : phi1))
                        : phi0 <= q[1] && q[1] <= phi1
        ...
        function resampleLineTo(
            ...
            if (d2 > 4 * delta2 && depth--) {
                var a = a0 + a1,
                    ...
                    phi2 = asin((c /= m)),
                    lambda2 =
                        abs(abs(c) - 1) < epsilon$2 ||
                        abs(lambda0 - lambda1) < epsilon$2
                            ? (lambda0 + lambda1) / 2
                            : atan2(b, a),
    ...
    function treeRoot(root) {
        ...
        while ((node = nodes.pop())) {
            if ((children = node._.children)) {
                ...
                for (i = n - 1; i >= 0; --i) {
                    nodes.push(
                        (child = node.children[i] = new TreeNode(
                            children[i],
                            i
                        ))
                    );
                        ...
                        halfedges.splice(
                            ...
                            edges.push(
                                createBorderEdge(
                                    ...
                                    Math.abs(endX - x0) < epsilon$4 &&
                                        y1 - endY > epsilon$4
                                        ? [
                                              x0,
                                              Math.abs(startX - x0) < epsilon$4
                                                  ? startY
                                                  : y1
                                          ]
                                        : Math.abs(endY - y1) < epsilon$4 &&
                                          x1 - endX > epsilon$4
                                        ? [
                                              Math.abs(startY - y1) < epsilon$4
                                                  ? startX
                                                  : x1,
                                              y1
                                          ]
                                        : Math.abs(endX - x1) < epsilon$4 &&
                                          endY - y0 > epsilon$4
                                        ? [
                                              x1,
                                              Math.abs(startX - x1) < epsilon$4
                                                  ? startY
                                                  : y0
                                          ]
    ...
    function defaultWheelDelta() {
        return (
            (-exports.event.deltaY * (exports.event.deltaMode ? 120 : 1)) / 500
        );
    }
    ...
    function zoom() {
        ...
        function touchstarted() {
            ...
            for (i = 0; i < n; ++i) {
                (t = touches$$1[i]),
                    (p = touch(this, touches$$1, t.identifier));
